...
echo "[ml-opt] run ML pruning optimization"
${PYTHON_CMD} "${ROOT_DIR}/scripts/optimize_pruning_ml.py" \
  ...
  --out "${ROOT_DIR}/data/results/pruning_optimization_ml.csv"

echo "[ml-opt] done: data/results/pruning_optimization_ml.csv"
